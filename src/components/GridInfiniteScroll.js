              ...
              <Card elevation="large" width="medium">
                ...
                <Box pad={{ horizontal: 'medium' }} responsive={false}>
                  ...
                  <Paragraph margin={{ top: 'none' }}>
                    A structure carrying a road, path, railroad, or canal across
                ...
                <Collapsible open={open}>
                  <Paragraph margin="medium" color="dark-3">
                    ...
                    Romans. The Romans built arch bridges and aqueducts that
                    could stand in conditions that would damage or destroy
                    earlier designs. Some stand today.
                  </Paragraph>
                </Collapsible>
              </Card>
            </Box>
